...
import 'package:flutter_journey/day9/redux/theme_i18n/i18n/i18n_delegate.dart';
import 'package:flutter_journey/day9/redux/theme_i18n/redux.dart';
import 'package:flutter_journey/day9/redux/theme_i18n/widgets/side_widget.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  StoreBuilder<AppState>(builder: (context, store) {
      return  Localizations.override(//注意要override包一下
        context: context,
        locale: store.state.locale,
        child: Scaffold(
          drawer: SideWidget(),

  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body:NestedScrollView(
      headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
        ...
        titlePadding: EdgeInsets.only(left: 45,bottom: 12),
        collapseMode: CollapseMode.parallax,//视差效果
        title: const Text('世界设计师',style: TextStyle(color:Colors.black,shadows: [Shadow(color: Colors.blue,offset: Offset(1, 1),blurRadius: 2)]),),
